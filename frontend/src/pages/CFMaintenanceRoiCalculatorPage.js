...
export default function CFMaintenanceRoiCalculatorPage() {
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Maintenance ROI calculator</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Maintenance ROI calculator: Compare maintenance strategy costs (PM, corrective, CM) vs. production losses; recommend optimal strategy per asset</p>
