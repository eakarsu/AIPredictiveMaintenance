...
export default function GapAlertsWithoutAlertPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await apiFetch('/api/gap-alerts-without-alert/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Alerts without '/alert</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Alerts without /alert-fatigue-reduce (suppress low-priority alerts)</p>
