...
export default function GapNoWebhooksForExternalSystemsPage() {
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No webhooks for external systems</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No webhooks for external systems</p>
