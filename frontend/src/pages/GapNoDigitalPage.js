...
export default function GapNoDigitalPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await apiFetch('/api/gap-no-digital/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No '/digital</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No /digital-twin-simulate despite the rich data layer</p>
