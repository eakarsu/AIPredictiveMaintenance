...
export default function CFDigitalTwinSimulationPage() {
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Digital twin simulation</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Digital twin simulation: AI model of equipment behavior; simulate different maintenance strategies (PM interval, corrective timing); predict long-term costs and downtime</p>
